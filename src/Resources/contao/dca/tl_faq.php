...
$GLOBALS['TL_DCA']['tl_faq']['palettes']['__selector__'][] = 'hofff_st_twitter_type';

$GLOBALS['TL_DCA']['tl_faq']['subpalettes']['hofff_st'] = 'hofff_st_og_type'
...
$GLOBALS['TL_DCA']['tl_faq']['subpalettes']['hofff_st_twitter_type_hofff_st_twitter_summary'] =
    ',hofff_st_twitter_title'
    . ',hofff_st_twitter_image'
    . ',hofff_st_twitter_site'
    . ',hofff_st_twitter_description';

$GLOBALS['TL_DCA']['tl_faq']['subpalettes']['hofff_st_twitter_type_hofff_st_twitter_summary_large_image'] =
    ',hofff_st_twitter_title'
    . ',hofff_st_twitter_image'
    . ',hofff_st_twitter_site'
...
// Fields
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st'] = [
    'label'     => &$GLOBALS['TL_LANG']['tl_faq']['hofff_st'],
    'exclude'   => true,
    'inputType' => 'checkbox',
    'eval'      => [
        'submitOnChange'     => true,
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_og_type'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_og_title'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_og_site'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_og_url'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_og_image'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_og_description'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_twitter_type'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_twitter_title'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_twitter_description'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_twitter_site'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_twitter_creator'] = [
...
$GLOBALS['TL_DCA']['tl_faq']['fields']['hofff_st_twitter_image'] = [
