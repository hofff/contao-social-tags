...
$GLOBALS['TL_LANG']['bbit_st']['types']['profile'] = 'Profil';

$GLOBALS['TL_LANG']['bbit_st']['types']['book']                = 'Buch';
$GLOBALS['TL_LANG']['bbit_st']['types']['music']               = 'Musik';
$GLOBALS['TL_LANG']['bbit_st']['types']['music.song']          = 'Lied';
$GLOBALS['TL_LANG']['bbit_st']['types']['music.album']         = 'Album';
$GLOBALS['TL_LANG']['bbit_st']['types']['music.playlist']      = 'Abspielliste';
$GLOBALS['TL_LANG']['bbit_st']['types']['music.radio_station'] = 'Radiosender';

$GLOBALS['TL_LANG']['bbit_st']['types']['video']         = 'Video';
$GLOBALS['TL_LANG']['bbit_st']['types']['video.movie']   = 'Kinofilm';
$GLOBALS['TL_LANG']['bbit_st']['types']['video.episode'] = 'Episode';
$GLOBALS['TL_LANG']['bbit_st']['types']['video.tv_show'] = 'TV-Show';
